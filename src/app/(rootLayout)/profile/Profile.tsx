                        ...
                        <div className="card-creator"> 
                            <div className="header-creator"> 
                                <div className="div_image_v-creator">
                                    ...
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20 7L9.00004 18L3.99994 13" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    </div> 
                                </div> 
                                <div className="content-creator">
                                    <span className="title-creator">Order validated</span> 
                                    <p className="message-creator">Thank you for your purchase. you package will be delivered within 2 days of your purchase</p> 
                                </div> 
                            </div> 
                        </div>
                    </div>
